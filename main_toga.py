...
Main entry point for the Toga-based application.
This module:
1. Sets up logging
...
Usage:
    ...
    python main_toga.py --debug      # Debug mode (logs scroll events)
"""
...
def setup_logging(debug: bool = False) -> None:
    ...
    logger.info("=" * 60)
    logger.info(f"Lokal-RAG Application Starting - Toga UI V2 (Log Level: {logging.getLevelName(log_level)})")
    logger.info("=" * 60)
